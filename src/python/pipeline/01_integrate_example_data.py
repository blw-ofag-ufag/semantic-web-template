...
def main():
    ...
    ARTIST = Namespace("https://agriculture.ld.admin.ch/eCH-1234/2/artist/")
    ALBUM = Namespace("https://agriculture.ld.admin.ch/eCH-1234/2/album/")
    TRACK = Namespace("https://agriculture.ld.admin.ch/eCH-1234/2/tracks/")
    GENRE = Namespace("https://agriculture.ld.admin.ch/eCH-1234/2/genre/")
    PLAYLIST = Namespace("https://agriculture.ld.admin.ch/eCH-1234/2/playlist/")
    MEDIATYPE = Namespace("https://agriculture.ld.admin.ch/eCH-1234/2/mediatype/")
    EMPLOYEE = Namespace("https://agriculture.ld.admin.ch/eCH-1234/2/employee/")
    CUSTOMER = Namespace("https://agriculture.ld.admin.ch/eCH-1234/2/customer/")
    INVOICE = Namespace("https://agriculture.ld.admin.ch/eCH-1234/2/invoice/")
    INVOICELINE = Namespace("https://agriculture.ld.admin.ch/eCH-1234/2/invoiceline/")
    ADDRESS = Namespace("https://agriculture.ld.admin.ch/eCH-1234/2/address/")

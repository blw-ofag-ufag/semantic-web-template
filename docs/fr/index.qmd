...
Les informations de ce chapitre doivent donner au lecteur un aperçu rapide de ce à quoi ce standard est destiné.
Des indications sur les éléments suivants peuvent s'avérer utiles.
...
La base technologique de cette approche est le [Resource Description Framework (RDF)](https://www.w3.org/TR/rdf11-concepts/), un standard central du World Wide Web Consortium (W3C) pour la modélisation des structures de données sur le Web.
...
# Annexe A - Références {.appendix .unnumbered}

::: {#refs}
:::

# Annexe B - Collaboration et Vérification {.appendix .unnumbered}

# Annexe C - Abréviations et glossaire {.appendix .unnumbered}

# Annexe D - Modifications par rapport à la version précédente {.appendix .unnumbered}

# Annexe E - Table des illustrations {.appendix .unnumbered}

# Annexe F - Liste des tableaux {.appendix .unnumbered}
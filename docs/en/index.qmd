...
The technological basis for this is the Resource Description Framework [RDF, @cyganiak2014rdf11], a central standard of the World Wide Web Consortium (W3C) for modeling data structures on the web.
